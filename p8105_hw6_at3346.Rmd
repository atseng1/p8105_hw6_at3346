...
The variables I hypothesize that underlie baby's birthweight include: babysex, bhead, blength, delwt, gaweeks, momage, pnumlbw, and pnumsga. I will plot each of these hypothesized variables against baby's birthweight.
...
The 95% confidence interval of r^2 is `r round(quantile(pull(bootstrap_rsquared, r.squared), probs = c(0.025, 0.975)), digits = 2)`.
...
The 95% confidence interval of log(β0*β1) is `r round(quantile(pull(bootstrap_logbetas, log_betas), probs = c(0.025, 0.975)), digits = 2)`.
